...
function BoardReply() {
    ...
    const getBoardIdx = async () => {
        try {
            ...
            setTitle("└답변 : " + response.data.title);
            setIsPrivate(response.data.isPrivate);
            setContent("답변작성<br/>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------<br/>");
        } catch (e) {
            console.log(e);
        }
    };
                ...
                <div className="container">
                    ...
                    <div className="wrap_write">
                        <dl className="write_tit">
                            <dt>제목</dt>
                            <dd><input type="text" name='title' className="comm_inp_text" style={{ width: '100%' }} value={title} onChange={(e) => {setTitle(e.target.value)}}  readOnly/></dd>
                        </dl>
                            ...
                            <dl className="side">
                                ...
                                <dd>
                                    <label className="comm_swich">
                                        <input type="checkbox" name='isAlert' checked={isAlert === 1} onChange={handleAlertChange} disabled />
                                ...
                                <dd>
                                    <label className="comm_swich">
                                        <input type="checkbox" name='isPrivate'checked={isPrivate === 1}/>
                                        <span className="ico_txt"></span>
                                    </label>
                                </dd>
                            </dl>
